...
export const zInitiative = z
	.strictObject({
		...
		currentTurnGroupId: z
			.union([
				z.number().int().describe('The id of the group whose turn it is'),
				z.null().describe('The id of the group whose turn it is'),
			])
			.describe('The id of the group whose turn it is'),
