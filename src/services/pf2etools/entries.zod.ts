import { z } from 'zod';
import { zActivitySchema, zFrequencySchema, zTypedNumberSchema } from './helpers.zod.js';
...
type Pf2EKeyAbility = z.infer<typeof zPf2EKeyAbilitySchema>;
export const zPf2EKeyAbilitySchema = z.object({
...
const zImageEntrySchema = z.object({
...
export const zAbilityListEntrySchema = z.object({
...
export const zTableGroupEntrySchema = z.object({
