...
const test: Organization[] = [
	{
		...
		source: 'LOCG',
		page: 68,
		traits: ['cg', 'large', 'revolutionary'],
		title: ['Grandstanding thrill seekers and dedicated rebels'],
		scope: ['regional (Inner Sea; moderate)'],
		goals: ['create lasting legacies', 'end tyranny', 'help the displaced', 'seek thrills'],
		headquarters: ['decentralized'],
		keyMembers: ['Devrin Arlos', 'Ranik Helt', 'Captain Shimali Manux', 'Shensen'],
		allies: [
		...
		assets: ['armaments', 'contacts', 'training', 'transportation'],
	...
	},
	{
		...
		source: 'LOCG',
		page: 78,
		traits: ['ln', 'large', 'militaristic'],
		title: ['Bastions of absolute law and enemies of disorder, chaos, and anarchy'],
		scope: [
		...
		enemies: ['bandits', 'cultists', 'rogue political elements; others depending on the order'],
		assets: [
			'contacts',
			'influence',
		...
		requirements: ['pass the Hellknight Test'],
		followerAlignment: [
			{
				main: 'ln',
				secondary: ['lg', 'le'],
		...
		values: ['law', 'peace through order', 'enforcing legal codices'],
		anathema: ['disobeying or undermining the Measure and the Chain'],
		hasLore: true,
	},
	{
		...
		source: 'LOCG',
		page: 88,
		traits: ['cg', 'lg', 'large', 'militaristic'],
		title: ['Righteously vowed foes of the Whispering Tyrant'],
		scope: [
		...
		assets: ['armaments', 'contacts', 'influence', 'magic items', 'training'],
		requirements: [
	...
	},
	{
		...
		source: 'LOCG',
		page: 98,
		traits: ['ng', 'huge', 'academic'],
		title: ['Communitarian advancers of ancient knowledge and magic'],
		scope: [
		...
		headquarters: ['Nantambu, Vellumis'],
		keyMembers: [
			'Aengasi Soilseer',
			'Demuwe Gwaro',
		...
		requirements: ["earn a Magaambyan's respect, and pass an entrance interview"],
		followerAlignment: [
			{
				main: 'ng',
	...
	},
	{
		...
		source: 'LOCG',
		page: 108,
		traits: ['n', 'huge', 'academic', 'wayfaring'],
		title: ['Adventuring scholars of historical lore'],
		scope: ['global (varies by region)', 'local (Absalom; strong)'],
		goals: [
		...
		assets: ['contacts', 'financing', 'influence', 'magic items', 'training', 'transportation'],
		requirements: [
