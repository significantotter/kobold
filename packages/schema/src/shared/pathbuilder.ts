...
export namespace PathBuilder {
	...
	export type AbilityUppercase = z.infer<typeof abilityUppercaseSchema>;
	export type SpellTradition = z.infer<typeof spellTraditionSchema>;
	export type Attributes = z.infer<typeof zPathBuilderAttributesSchema>;
	export type Abilities = z.infer<typeof zPathBuilderAbilitiesSchema>;
	export type Proficiencies = z.infer<typeof zPathBuilderProficienciesSchema>;
	export type SpecificProficiencies = z.infer<typeof zPathBuilderSpecificProficienciesSchema>;
	export type Weapon = z.infer<typeof zPathBuilderWeaponSchema>;
	export type Money = z.infer<typeof zPathBuilderMoneySchema>;
	export type Armor = z.infer<typeof zPathBuilderArmorSchema>;
	export type FocusCasting = z.infer<typeof zPathBuilderFocusCastingSchema>;
	export type FocusCastingStat = z.infer<typeof zPathBuilderFocusCastingStatSchema>;
	export type Focus = z.infer<typeof zPathBuilderFocusSchema>;
	export type SpellsAtLevel = z.infer<typeof zPathBuilderSpellsAtLevelSchema>;
	export type SpellCasting = z.infer<typeof zPathBuilderSpellCastingSchema>;
	export type Pet = z.infer<typeof zPathBuilderPetsSchema>;
	export type Formula = z.infer<typeof zPathBuilderFormulaSchema>;
	export type Character = z.infer<typeof zPathBuilderCharacterSchema>;
	export type JsonExport = z.infer<typeof zPathBuilderJsonExportSchema>;
}

const PATHBUILDER_USER_AGENT =
