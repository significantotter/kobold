...
export const initCommandOptions = {
	...
	[InitCommandOptionEnum.initNpc]: {
		name: InitCommandOptionEnum.initNpc,
		description: 'An NPC present in the initiative.',
		required: true,
		autocomplete: true,
		type: ApplicationCommandOptionType.String,
	},
	...
	[InitCommandOptionEnum.initCustomStats]: {
		name: 'custom-stats',
		description: 'Mutable stat overrides. In the format "hp=35;ac=20;will=7"',
		required: false,
		type: ApplicationCommandOptionType.String,
	},
	[InitCommandOptionEnum.npcStats]: {
		name: InitCommandOptionEnum.npcStats,
		description: 'Mutable stat updates. In the format "hp=35;ac=20;will=7"',
		required: false,
		type: ApplicationCommandOptionType.String,
	},
	[InitCommandOptionEnum.level]: {
		name: InitCommandOptionEnum.level,
		description: "The NPC's level.",
		required: false,
		type: ApplicationCommandOptionType.Integer,
	},
	[InitCommandOptionEnum.keyAbility]: {
		name: InitCommandOptionEnum.keyAbility,
		description: "The NPC's key ability, or None to clear it.",
		required: false,
		type: ApplicationCommandOptionType.String,
		choices: [
	...
	[InitCommandOptionEnum.usesStamina]: {
		name: InitCommandOptionEnum.usesStamina,
		description: 'Whether the NPC uses the alternate stamina rules.',
		required: false,
		type: ApplicationCommandOptionType.Boolean,
	},
