...
export const zSubRitualMiniSchema = z.strictObject({
	name: z.string(),
...
export type RitualMini = z.infer<typeof zRitualMiniSchema>;
export const zRitualMiniSchema = z.strictObject({
	tradition: z.string().optional(),
	DC: z.union([z.number(), z.string()]).optional(),
	rituals: zSubRitualMiniSchema.or(zSubRitualMiniSchema.array()),
});
