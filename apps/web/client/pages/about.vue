<template>
	<div class="overflow-auto px-4 pt-10">
		<main class="prose dark:prose-invert max-w-3xl mx-auto">
			...
			<p>
				Kobold integrates the excellent character management website Pathbuilder 2E with
				discord for play by post pathfinder 2E games.
			</p>
			<h3>Features</h3>
			<ul>
				...
				<li>Use flexible modifiers to track bonuses and penalties to dice roll</li>
				<li>Reference most Pathfinder 2E content with the compendium command</li>
			</ul>
			<h3>Links</h3>
			<ul>
				<li>
					<a
						...
						>Invite Kobold to a Discord Server</a
					>
				</li>
				<li>
					<a href="https://ko-fi.com/significantotter"
						>Support Kobold's development through ko-fi</a
					>
				</li>
				<li>
					<a href="https://discord.gg/6bS2GM59uj"
						>Join Kobold's Support Server on Discord</a
					>
				</li>
				<li>
					<a href="https://github.com/significantotter/kobold">
