...
import { CounterDefinition as CounterCommandDocumentation } from '@kobold/documentation';

export class CounterCommand extends BaseCommandClass(CounterCommandDocumentation) {
