...
import { ConditionDefinition as ConditionCommandDocumentation } from '@kobold/documentation';

export class ConditionCommand extends BaseCommandClass(ConditionCommandDocumentation) {
