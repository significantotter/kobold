...
import { ModifierDefinition as ModifierCommandDocumentation } from '@kobold/documentation';

export class ModifierCommand extends BaseCommandClass(ModifierCommandDocumentation) {
