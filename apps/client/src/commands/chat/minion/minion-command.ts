...
import { MinionDefinition as MinionCommandDocumentation } from '@kobold/documentation';

export class MinionCommand extends BaseCommandClass(MinionCommandDocumentation) {
