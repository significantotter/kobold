...
import { CounterGroupDefinition as CounterGroupCommandDocumentation } from '@kobold/documentation';

export class CounterGroupCommand extends BaseCommandClass(CounterGroupCommandDocumentation) {
