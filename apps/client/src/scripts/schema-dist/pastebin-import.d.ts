 ...
 * The attack notes.
 */
notes: null | string } & { [x: string]: never }> } & { [x: string]: never }, modifiers?: Array<{ description: null | string, id: number, isActive: boolean, name: string, note: null | string, rollAdjustment: null | string, rollTargetTags: null | string, severity: null | number, sheetRecordId: null | number, type: ("untyped" | "status" | "circumstance" | "item"), userId: string, sheetAdjustments: Array<{ property: string, propertyType: ("info" | "infoList" | "intProperty" | "baseCounter" | "weaknessResistance" | "stat" | "attack" | "extraSkill" | "statGroup" | ""), operation: ("+" | "-" | "="), value: string, type: ("untyped" | "status" | "circumstance" | "item") } & { [x: string]: never }> }>, actions?: Array<{ actionCost: null | string, autoHeighten: boolean, baseLevel: null | number, description: string, id: number, name: string, sheetRecordId: null | number, type: null | string, userId: string, rolls: Array<({ name: string, allowRollModifiers: boolean, type: ("attack" | "skill-challenge"), targetDC: null | string, roll: string } & { [x: string]: never } | { name: string, allowRollModifiers: boolean, type: "damage", damageType: null | string, healInsteadOfDamage: boolean, roll: null | string } & { [x: string]: never } | { name: string, allowRollModifiers: boolean, type: "advanced-damage", damageType: null | string, healInsteadOfDamage: boolean, criticalSuccessRoll: null | string, criticalFailureRoll: null | string, successRoll: null | string, failureRoll: null | string } & { [x: string]: never } | { name: string, allowRollModifiers: boolean, type: "save", saveRollType: null | string, saveTargetDC: null | string } & { [x: string]: never } | { name: string, allowRollModifiers: boolean, type: "text", defaultText: null | string, criticalSuccessText: null | string, criticalFailureText: null | string, successText: null | string, failureText: null | string, extraTags: Array<string> } & { [x: string]: never })>, tags: Array<string> }>, rollMacros?: Array<{ id: number, macro: string, name: string, sheetRecordId: null | number, userId: string }> }
